 ...
 * (não aparece na tela Welcome nem no detalhe de uma memória).
 * O botão "Criar" recebe destaque visual pois representa a ação central
 * do app: registrar uma memória.
 */
