          ...
          >
            ...
            <GlassCard className="overflow-hidden !p-0">
              {group.items.map(({ icon: Icon, label }, index) => (
                ...
                >
                  <div className="flex h-8 w-8 items-center justify-center rounded-full bg-white/5 text-lumia-ink-muted transition-colors duration-300 group-hover:text-lumia-gold">
