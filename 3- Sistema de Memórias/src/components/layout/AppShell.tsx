 ...
 *
 * Refinamento visual: glow ambiente mais rico, textura de grão sutil
 * (sensação de filme/nostalgia) e um friso de luz fino na borda da
 * "vitrine" para um acabamento mais premium.
 */
