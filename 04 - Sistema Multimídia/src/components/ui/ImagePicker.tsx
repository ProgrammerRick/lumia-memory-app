 ...
 *
 * Nesta etapa, permite escolher uma imagem da galeria/dispositivo (input de
 * arquivo nativo, `accept="image/*"`), convertendo-a para uma data URL
 * guardada localmente. A estrutura já isola essa responsabilidade em um
 * componente único para que, no futuro, capturas de câmera ou vídeo possam
 * ser adicionadas aqui sem alterar as telas que o utilizam.
 */
