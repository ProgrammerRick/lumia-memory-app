...
export function BottomNav() {
  ...
  return (
    <nav className="absolute inset-x-0 bottom-0 z-20 px-5 pb-[calc(env(safe-area-inset-bottom)+18px)] pt-3">
      <div className="glass-panel-strong flex items-center justify-between rounded-[28px] px-3 py-2.5 shadow-lumia-soft">
          ...
          if (isCreate) {
            return (
              <motion.button
                ...
                className="relative -mt-7 flex h-14 w-14 items-center justify-center rounded-full bg-gradient-to-b from-[#f3d9a8] to-[#c98f4a] text-[#241505] shadow-[0_10px_30px_-8px_rgba(232,181,115,0.7)]"
              >
