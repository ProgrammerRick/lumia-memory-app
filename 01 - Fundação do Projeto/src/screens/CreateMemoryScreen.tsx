        ...
        <div className="grid grid-cols-2 gap-4">
          {MEMORY_TYPES.map(({ icon: Icon, label }, index) => (
            <GlassCard
              ...
              className="flex aspect-square flex-col items-center justify-center gap-3 opacity-90"
            >
              <div className="flex h-12 w-12 items-center justify-center rounded-full bg-white/5 text-lumia-gold">
