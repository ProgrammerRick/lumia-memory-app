...
/**
 * Tela de configurações — nesta fase, apenas exibe grupos de preferências
 * visuais/estáticas (sem lógica real de conta, nuvem ou notificações,
 * conforme o escopo do produto). Serve como vitrine de preferências futuras.
 */
